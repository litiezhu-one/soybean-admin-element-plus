...
import LotteryOperateDrawer from './modules/lottery-operate-drawer.vue';
import LotterySearch from './modules/lottery-search.vue';
...
<template>
  <div class="min-h-500px flex-col-stretch gap-16px overflow-hidden lt-sm:overflow-auto">
    <LotterySearch v-model:model="searchParams" @search="getDataByPage"/>
